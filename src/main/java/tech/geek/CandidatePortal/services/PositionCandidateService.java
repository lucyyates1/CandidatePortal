...
public class PositionCandidateService {
    ...
    public PositionCandidate getPositionCandidateSpecific(Position position, Application application)
    {
        ...
        for(PositionCandidate pc : PosCans)
            if(pc.getCandidate().getApplication_id() == application.getApplication_id())
