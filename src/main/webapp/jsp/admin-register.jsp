...
<html>
    ...
    <body>
        ...
        <div class="localWrapper">
            ...
            <form:form name="RegForm" onsubmit="return validate()" action="${pageContext.request.contextPath}/admin/register" method="POST">
                <span class="error">${firstnameError}</span>
                <input class="formInput" type="text" name="first_name" placeholder="First Name" spellcheck="false"/>
                <span class="error">${lastnameError}</span>
                <input class="formInput" type="text" name="last_name" placeholder="Last Name" spellcheck="false"/>
