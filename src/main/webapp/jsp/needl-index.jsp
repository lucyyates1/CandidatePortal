    ...
    <body>
        <div class="wrapper">
            <div class="innerWrapper">
                <div class="left">
                    <h1 style="padding-bottom: 1rem;">Welcome to Needl&trade; ${username}!</h1>

                    <p class="tagLine">We'll dive deep into your haystack of candidates to find just the person you're looking for.</p>

                    <h3 style="margin-top: 2rem; margin-bottom: 0.5rem;">Here are your current metrics:</h3>
                    <p class="metrics">Active Positions: ${activePositions}</p>
                    <p class="metrics">Filled Positions: ${filledPositions}</p>
                    <p class="metrics">Candidates: ${numCandidates}<p>

                    <h3 style="margin-top: 2rem;">Latest Positions:</h3>
